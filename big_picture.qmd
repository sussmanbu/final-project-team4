...
*Thesis:* By analyzing extensive education data, we will be able to identify where educational disparities are, and answer the question of why these disparities exist. On top of answering these questions, we will use the power of this dataset to identify insights that have the power to make a change.
...
### While Africa is the worst performer, Northern Africa is performing a lot better than Sub-Saharan Africa.
...
Our statistical modeling has revealed critical insights into the factors influencing secondary education completion rates, particularly in the regions of Africa and South America. Findings indicate that residing in rural areas, being in lower wealth brackets, and being located in Africa significantly hinder secondary education achievement. Conversely, high rates of primary education completion have been shown to positively impact secondary education success.
...
***So what does this mean?*** These insights are crucial for policymakers and educational organizations aiming to improve education systems and tailor interventions that support educational attainment across varying socioeconomic and geographic landscapes.