...
```{r}
#| label: made Arcsine Square Root transformation on the response variable "comp_lowsec_v2_m"
#| echo: false
#| warning: false
...
# Plot the first histogram of the original data
hist(Location_data$comp_lowsec_v2_m, main = "Histogram of comp_lowsec_v2_m", xlab = "comp_lowsec_v2_m", col = "blue")

# Plot the second histogram of the transformed data
# Ensure all values are within (0,1) before applying asin(sqrt(.))
# Adjusting values if necessary
Location_data$comp_lowsec_v2_m_adj <- pmin(pmax(Location_data$comp_lowsec_v2_m, 1e-4), 1 - 1e-4)
hist(asin(sqrt(Location_data$comp_lowsec_v2_m_adj)), main = "Histogram of Transformed comp_lowsec_v2_m", xlab = "asin(sqrt(comp_lowsec_v2_m))", col = "green")
...
####plot histogram
# Adjust plotting area to have 1 row and 2 columns
par(mfrow=c(1, 2))
